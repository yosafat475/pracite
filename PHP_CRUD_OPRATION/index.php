...
<table class="table table-striped">
    ...
    <tbody>
        <?php foreach ($data_daftar as $key):?>
            <tr>
                <td><?php echo $key['kopi'];?></td>
                <td><?php echo $key['rasa'];?></td>
                <td><a href="delete.php?idp=<?php echo $key['idp']; ?>">Hapus</a> | <a href="edit.php?idp=<?php echo $key['idp']; ?>">Edit</a></td>
            </tr>
<?php endforeach; ?>
    </tbody>
</table>
    ...
    <div class="row">
        ...
        <form action="input.php" method="POST">
                <div class="form-group">
                    ...
                    <input type="text" name="kopi" class="form-control">
                </div>
                <div class="form-group">
